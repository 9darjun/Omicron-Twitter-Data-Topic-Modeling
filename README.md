I have coded this project using Jupyter Notebook by Anaconda. The following are the required packages needed to be installed through the conda prompt or cmd to run this project. 
